...
displayColumns: any[] = [
  {field:'reportDate', i18n:'report-date'},
  {field:'totalCases', i18n:'daily-total'},
  {field:'newCases', i18n:'daily-new'},
  {field:'totalDeaths', i18n:'daily-total-deaths'},
  {field:'newDeaths', i18n:'daily-new-deaths'},
  {field:'activeCases', i18n:'daily-active'},
  {field:'criticalCases', i18n:'daily-serious'},
  {field:'newRecovered', i18n:'daily-total-recovered'},
];
  dataSource: any;
  ...
  constructor(private dailyStatusService: DailyStatusService, private alertService: AlertService) {
    this.dailyStatusService.getAllCaseStats().subscribe(result=>{
     ...
     // this.dataSource.paginator = this.paginator;
      ...
      const gradientStroke1 = this.ctx.createLinearGradient(0, 10, 0, 5);
      ...
      const gradientStroke3 = this.ctx.createLinearGradient(0, 230, 0, 50);
      ...
      this.ctx  = this.canvas.getContext("2d");
      const gradientStroke4 = this.ctx.createLinearGradient(0, 2300, 0, 50);
